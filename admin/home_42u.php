...
<h3><span class="glyphicon glyphicon-briefcase"></span>  CLOS RACK 42 U</h3>
...
<?php 
$per_hal=10;
$jumlah_record=mysql_query("SELECT COUNT(*) from clos_rack_42u");
...
<div class="col-md-12">
	...
	<a style="margin-bottom:10px" href="lap_42u.php" target="_blank" class="btn btn-default pull-right"><span class='glyphicon glyphicon-print'></span>  Cetak</a>
</div>
...
<table class="table table-hover">
	...
	if(isset($_GET['cari'])){
		...
		$brg=mysql_query("select * from clos_rack_42u where Tanggal like '$cari' or Project like '$cari'");
	}else{
		$brg=mysql_query("select * from clos_rack_42u limit $start, $per_hal");
	}
	$no=1;
	while($b=mysql_fetch_array($brg)){
		...
		<tr>
			...
			<a href="edit_30u.php?No=<?php echo $b['No']; ?>" class="btn btn-warning">Edit</a>
				<a onclick="if(confirm('Apakah anda yakin ingin menghapus data ini ??')){ location.href='hapus_42u.php ?No=<?php echo $b['No']; ?>' }" class="btn btn-danger">Hapus</a>
			</td>
		</tr>		
		<?php 
	}
	...
	<tr>
		...
		<?php 
			...
			$x=mysql_query("select sum(Masuk-Keluar) as total from clos_rack_42u");	
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">Tambah Data Clos Rack 42 U</h4>
			</div>
			<div class="modal-body">
				<form action="tmb_42u.php" method="post">
