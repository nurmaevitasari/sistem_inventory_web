...
<h3><span class="glyphicon glyphicon-briefcase"></span> PATCH CORD FO LC</h3>
...
<?php 
$per_hal=10;
$jumlah_record=mysql_query("SELECT COUNT(*) from patch_fo_lc");
...
<div class="col-md-12">
	...
	<a style="margin-bottom:10px" href="lap_fo_lc.php" target="_blank" class="btn btn-default pull-right"><span class='glyphicon glyphicon-print'></span>  Cetak</a>
</div>
...
<table class="table table-hover">
	...
	if(isset($_GET['cari'])){
		...
		$brg=mysql_query("select * from patch_fo_lc where Tanggal like '$cari' or Project like '$cari'");
	}else{
		$brg=mysql_query("select * from patch_fo_lc limit $start, $per_hal");
	}
	$no=1;
	while($b=mysql_fetch_array($brg)){
		...
		<tr>
			...
			<td>
			<a href="edit_fo_lc.php?No=<?php echo $b['No']; ?>" class="btn btn-warning">Edit</a>
				<a onclick="if(confirm('Apakah anda yakin ingin menghapus data ini ??')){ location.href='hapus_fo_lc.php ?No=<?php echo $b['No']; ?>' }" class="btn btn-danger">Hapus</a>
			</td>
		</tr>		
		<?php 
	}
	...
	<tr>
		...
		<?php 
			...
			$x=mysql_query("select sum(Masuk-Keluar) as total from patch_fo_lc");	
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">Tambah Data PATCH CORD FO LC</h4>
			</div>
			<div class="modal-body">
				<form action="tmb_fo_lc.php" method="post">
