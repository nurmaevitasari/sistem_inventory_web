...
<h3><span class="glyphicon glyphicon-briefcase"></span>  PATCH PANEL Cat 5</h3>
...
<?php 
$per_hal=10;
$jumlah_record=mysql_query("SELECT COUNT(*) from patch_panel_cat5");
...
<div class="col-md-12">
	...
	<a style="margin-bottom:10px" href="lap_cat5.php" target="_blank" class="btn btn-default pull-right"><span class='glyphicon glyphicon-print'></span>  Cetak</a>
</div>
...
<table class="table table-hover">
	...
	if(isset($_GET['cari'])){
		...
		$brg=mysql_query("select * from patch_panel_cat5 where Tanggal like '$cari' or Project like '$cari'");
	}else{
		$brg=mysql_query("select * from patch_panel_cat5 limit $start, $per_hal");
	}
	$no=1;
	while($b=mysql_fetch_array($brg)){
		...
		<tr>
			...
			<td>
			<a href="edit_2u.php?No=<?php echo $b['No']; ?>" class="btn btn-warning">Edit</a>
	...
	<tr>
		...
		<?php 
			...
			$x=mysql_query("select sum(Masuk-Keluar) as total from patch_panel_cat5");	
