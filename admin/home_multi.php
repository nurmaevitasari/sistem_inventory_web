...
<table class="table table-hover">
	...
	while($b=mysql_fetch_array($brg)){
		...
		<tr>
			...
			<td>
			<a href="edit_multi.php?No=<?php echo $b['No']; ?>" class="btn btn-warning">Edit</a>
				<a onclick="if(confirm('Apakah anda yakin ingin menghapus data ini ??')){ location.href='hapus_multi.php ?No=<?php echo $b['No']; ?>' }" class="btn btn-danger">Hapus</a>
			</td>
		</tr>		
		<?php 
	}
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">Tambah Data Cable Multi Pear</h4>
			</div>
			<div class="modal-body">
				<form action="tmb_multi.php" method="post">
