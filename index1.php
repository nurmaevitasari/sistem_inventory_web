<?php
session_start();
include_once 'direktur/config.php';
...
if(isset($_POST['btn-login']))
{
 ...
 $res=mysql_query("SELECT * FROM direktur WHERE uname='$uname'");
...
<h3>LOGIN SEBAGAI DIREKTUR</h3>
<br>
<h2>PT.ANUGRAH PRATAMA TEKNOLOGI</h2></font></center>
<br>
