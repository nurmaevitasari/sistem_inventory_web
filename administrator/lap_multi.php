...
$pdf->Cell(25.5,0.7,"Laporan Data Cable Multi Pear",0,10,'C');
$pdf->ln(1);
...
$pdf->SetFont('Arial','B',9);
$no=1;
$query=mysql_query("select * from cable_multi_pear");
while($lihat=mysql_fetch_array($query)){
	...
	$pdf->Cell(4, 0.8, $lihat['Project'], 1, 1,'C');
	$pdf->Cell(3, 0.8, $lihat['Stock'], 1, 1, 'C');

	$no++;
}

$pdf->Output("laporan_cable_multi_pear.pdf","I");
